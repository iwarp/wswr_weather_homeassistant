...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("rainfal_01mnacc", {"device_class": SensorDeviceClass.PRECIPITATION, "unit": UnitOfLength.MILLIMETERS, "state_class": SensorStateClass.TOTAL_INCREASING}),
        ("rainfal_01mnavg", {"device_class": SensorDeviceClass.PRECIPITATION, "unit": UnitOfLength.MILLIMETERS, "state_class": SensorStateClass.MEASUREMENT}),
        ("windspd_01mnavg", {"device_class": SensorDeviceClass.WIND_SPEED, "unit": UnitOfSpeed.KNOTS, "state_class": SensorStateClass.MEASUREMENT}),
        ("winddir_01mnavg", {"device_class": SensorDeviceClass.WIND_DIRECTION, "unit": DEGREE}),
        ("solradn_01mnavg", {"device_class": SensorDeviceClass.IRRADIANCE, "unit": UnitOfIrradiance.WATTS_PER_SQUARE_METER, "state_class": SensorStateClass.MEASUREMENT}),
        ...
        ("windrun_01hracc", {"device_class": SensorDeviceClass.DISTANCE, "unit": UnitOfLength.KILOMETERS, "state_class": SensorStateClass.TOTAL_INCREASING}),
        # Specific cases
        ("windgst_01hrtim", {}),  # Time string
        ("windgst_01hrdir", {"device_class": SensorDeviceClass.WIND_DIRECTION, "unit": DEGREE}),
        ("windcw__10mnmax", {"device_class": SensorDeviceClass.WIND_SPEED, "unit": UnitOfSpeed.KNOTS, "state_class": SensorStateClass.MEASUREMENT}),
        ("unknown_sensor", {}),
    ],
)
